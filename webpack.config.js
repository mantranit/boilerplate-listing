...
const config = {
  ...
  output: {
    filename: 'js/[name].js',
    path: path.resolve(__dirname, 'wordpress/wp-content/themes/fujielevator/assets'),
  },
  module: {
    rules: [
      {
  ...
  plugins: [
    new BrowserSyncPlugin({
      ...
      // server: {
      //   baseDir: ['wordpress/wp-content/themes/fujielevator'],
      //   directory: true,
      // },
    }),
    ...
    new CopyWebpackPlugin([
      {
        ...
        to: path.resolve(__dirname, 'wordpress/wp-content/themes/fujielevator', 'assets', 'images'),
        ignore: ['favicon.png', 'screenshot.png'],
        toType: 'dir',
      },
      {
        from: path.resolve(__dirname, 'app', 'images', 'favicon.png'),
        to: path.resolve(__dirname, 'wordpress/wp-content/themes/fujielevator', 'favicon.png'),
      },
      {
